import { isUrlAllowed, isUrlAllowedCompiled, compileSitePatterns, logit } from '../lib/utils';
import { ensureSettingsInitialized, getFromStorage } from '../lib/settings';

const CONTENT_SCRIPT_FILES = ['assets/js/utils.js', 'assets/js/settings.js', 'assets/js/core/scanner.js', 'assets/js/content.js'];
const CONTENT_STYLE_FILES = ['assets/css/index.css'];
